...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, korenQueueInitialize)
#endif

NTSTATUS
korenQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = korenEvtIoDeviceControl;
    queueConfig.EvtIoStop = korenEvtIoStop;
